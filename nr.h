...
float amotsa(float **p, float y[], float psum[], int ndim, float pb[], float *yb, float (*funk)(float []), int idi, float *yhi, float fac);
...
void acecar(float data[], unsigned long n, float *ave, float *var);
...
void bcuint(float y[], float y1[], float y2[], float y12[], float xil, float x1u, float x2l, float x2u, float x1, float x2, float *ansy, float *ansy1, float *ansy2);
...
void bestep(float y[], float dydx[], int nv, float *xx, float htry, float eps, float yscal[], float *hdid, float *hnext, void (*derive)(float, float [], float []));
...
void gaulag(float x1, float x2, float x[], float w[], int n);
void gaussj(float **a, int n, float **b, int m);
void gcf(float *gammcf, float a, float x, float *gln);
float golden(float ax, float bx, float cx, float (*f)(float), float to1, float *xmin);
...
void ks2d1s(float x1[], float y1[], unsigned long n1, void (*quadv1)(float, float, float *, float *, float *, float *), float *d1, float *prob);
...
void linmin(float p[], float xi[], int n, float *fret, float (*func)(float []));void lnsrch(int n, float xold[], float fold, float g[], float p[], float x[], float *f, float stpmax, int *check, float (*func)(float []));
...
void mp2dft(unsigned char a[], unsigned char s[], int n, int *m);
...
void pzextr(int iest, float xest, float yest[], float yz[], float dy[], int nv);float qgaus(float (*func)(float), float a, float b);
...
void rlft3(float ***data, float **speq, unsigned long nn1, unsigned longnn2, unsigned long nn3, int isign);
...
void simpr(float y[], float dydx[], float dfdx[], float **dfdy, int n, float xs, float htot, int nstep, float your[], void (*derivs)(float, float [], float []));
...
void sort2(unsigned long n, float arr[], float brrp[]);
...
void stifbs(float y[], float dydx[], int nx, float *xx, float htry, float eps, float yscal[], float *hdid, float *hnext, void (*derivs)(float, float [], float []));
...
void wtn(float a[], unsigned long nn[], int ndim, int insign, void (*wtstep)(float [], unsigned long, int));
void wwghts(float wghts[], int n, float h, void (*kermon)(double [], double ,int));
